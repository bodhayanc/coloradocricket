...
<!-- BEGIN add_event
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{ADD_EVENT_TGT}" title="{ADD_EVENT_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-addevent.gif" border="0" alt="{ADD_EVENT_LNK}" /><br />
							{ADD_EVENT_LNK}</a>
					</td>
 END add_event -->
<!-- BEGIN monthly_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{CAL_VIEW_TGT}" title="{CAL_VIEW_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-calendarview.gif" border="0" alt="{CAL_VIEW_LNK}" /><br />
							{CAL_VIEW_LNK}</a>
					</td>
<!-- END monthly_view -->
<!-- BEGIN weekly_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{WEEKVIEW_TGT}" title="{WEEKVIEW_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-weekly.gif" border="0" alt="{WEEKVIEW_LNK}" /><br />
							{WEEKVIEW_LNK}</a>
					</td>
<!-- END weekly_view -->
<!-- BEGIN daily_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{DAYVIEW_TGT}" title="{DAYVIEW_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-daily.gif" border="0" alt="{DAYVIEW_LNK}" /><br />
							{DAYVIEW_LNK}</a>
					</td>
<!-- END daily_view -->
<!-- BEGIN flyer_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{FLYER_VIEW_TGT}" title="{FLYER_VIEW_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-flyer.gif" border="0" alt="{FLYER_VIEW_LNK}" /><br />
							{FLYER_VIEW_LNK}</a>
					</td>
<!-- END flyer_view -->
<!-- BEGIN cat_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{CAT_VIEW_TGT}" title="{CAT_VIEW_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-cats.gif" border="0" alt="{CAT_VIEW_LNK}" /><br />
							{CAT_VIEW_LNK}</a>
					</td>
<!-- END cat_view -->
<!-- BEGIN search_view -->
					...
					<td class="buttontext" align="center" valign="middle">
						<a href="{SEARCH_TGT}" title="{SEARCH_LNK}" class="buttontext">
							<img src="{URL}/themes/pvc/images/icon-search.gif" border="0" alt="{SEARCH_LNK}" /><br />
							{SEARCH_LNK}</a>
					</td>
<!-- END search_view -->
					</td>
		...
		<td height='50' class='{DAY_CLASS}' align='center' valign='top' onMouseOver="cal_switchImage('add{DAY}', document.imageArray[0][1].src);cOn(this,'{HOVER_BG_COLOR}');showOnBar('{DATE_STRING}');return true;" onMouseOut="cal_switchImage('add{DAY}', document.imageArray[0][0].src);cOut(this,'{BG_COLOR}');showOnBar('');return true;">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<!-- // MSD Hide adding from the calendar
					<td class="caldaydigits" align="right">
