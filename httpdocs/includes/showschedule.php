...
function show_schedule($db,$schedule)
{
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
        ...
        // List by umpiring team for schedule 

                echo "<p class=\"10px\">Umpiring Team: ";
            //16-Apr-2017 - Bodha - Modified to list only the teams associated with the scorecards for that particular season
	    //$db->Query("SELECT * FROM teams WHERE TeamActive=1 AND LeagueID = 1 OR LeagueID = 4 ORDER BY TeamName");
            $db->Query("SELECT t.* FROM teams t, schedule s WHERE (s.umpire1 = t.TeamID OR s.umpire2 = t.TeamID) AND s.season=$schedule AND (s.league_id = 1 OR league_id = 4) GROUP BY t.TeamID ORDER BY TeamName");
            ...
            for ($x=0; $x<$db->rows; $x++) {
                ...
                $id = $db->data['TeamID'];
                $ab = $db->data['TeamAbbrev'];
                echo "<a href=\"$PHP_SELF?schedule=$schedule&umpire=$id&ccl_mode=4\">$ab</a> |\n";
            }
            echo "</p>\n";
...
function show_schedule_umpire($db,$schedule,$umpire)
{
        global $PHP_SELF, $bluebdr, $greenbdr, $yellowbdr;
		...
		if(array_key_exists($umpire, $teams)) {
        echo "<table width=\"100%\" cellpadding=\"10\" cellspacing=\"0\" border=\"0\">\n";
        echo "  <tr>\n";
        echo "    <td align=\"left\" valign=\"top\">\n";
        echo "<table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">\n";
        echo "<tr>\n";
        echo "  <td align=\"left\" valign=\"top\">\n";
        echo "  <a href=\"/index.php\">Home</a> &raquo; <a href=\"/schedule.php\">Schedule</a> &raquo; <font class=\"10px\">{$seasons[$schedule]} - {$teams[$umpire]}</font></p>\n";
        echo "  </td>\n";
        //echo "  <td align=\"right\" valign=\"top\">\n";
        //require ("navtop.php");
        //echo "  </td>\n";
        ...
        echo "<b class=\"16px\">{$seasons[$schedule]} Umpiring schedule for {$teams[$umpire]}</b><br>Games typically start at 10am. Click the ground for directions.<br><br>\n";

    //////////////////////////////////////////////////////////////////////////////////////////
    // Schedule Option Box
    //////////////////////////////////////////////////////////////////////////////////////////

        echo "<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"3\" bordercolor=\"#{$teamcolour[$umpire]}\" align=\"center\">\n";
        echo "  <tr>\n";
        echo "    <td bgcolor=\"#{$teamcolour[$umpire]}\" class=\"whitemain\" height=\"23\">OPTIONS</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
        echo "  <td class=\"trrow1\" valign=\"top\" bordercolor=\"#FFFFFF\" class=\"main\">\n";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
                ...
                echo "<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\" bordercolor=\"#{$teamcolour[$umpire]}\" align=\"center\">\n";
                echo "  <tr>\n";
                echo "    <td bgcolor=\"#{$teamcolour[$umpire]}\" class=\"whitemain\" height=\"23\">&nbsp;LEAGUE SCHEDULE </td>\n";
                echo "  </tr>\n";
                echo "  <tr>\n";
            echo "  <td class=\"trrow1\" valign=\"top\" bordercolor=\"#FFFFFF\" class=\"main\" colspan=\"2\">\n";
        ...
        if (!$db->Exists("SELECT * FROM schedule WHERE season=$schedule")) {
			...
			WHERE
              sch.season=$schedule
            AND
            (sch.umpire1=$umpire OR sch.umpire2=$umpire)
            ORDER BY
              sch.week, sch.date, sch.time");
			...
			$db->QueryRow("SELECT * FROM teams WHERE TeamID = $umpire");
			$tn = $db->data['TeamName']; 
			echo "<table width=\"100%\" cellpadding=\"10\" cellspacing=\"0\" border=\"0\">\n";
			echo "  <tr>\n";
			echo "    <td align=\"left\" valign=\"top\">\n";
...
if (isset($_GET['ccl_mode'])) {
	...
	case 3:
		...
		break;
	case 4:
		show_schedule_umpire($db, $_GET['schedule'], $_GET['umpire']);
		break;
	default:
		show_schedule_listing($db);
		break;
