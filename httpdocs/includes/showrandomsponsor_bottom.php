...
function show_randomsponsor_bottom($db)
{
	...
	if (!$db->Exists("SELECT * FROM sponsors WHERE isActive=1")) {
		...
		echo "
			...
			imageholder1[i].src='/uploadphotos/sponsors/' + slideimagesb[i]
			}
		...
		";
             ...
             //   echo "<br><center><a href=\"javascript:gotoshowb()\"><img src=\"/uploadphotos/sponsors/$first_img\" name=\"slidebottom\" border=0 style=\"filter:blendTrans(duration=3)\"></a></center>"; 
		echo "<br><center><a href=$first_href target='_blank'><img src=\"/uploadphotos/sponsors/$first_img\" name=\"slidebottom\" border=0 style=\"filter:blendTrans(duration=3)\"></a></center>"; 		
//echo "<br><center><a href=\"javascript:gotoshowb()\"><img src=\"/uploadphotos/sponsors/$img_files\" name=\"slidebottom\" border=0 style=\"filter:blendTrans(duration=3)\" //></a></center>";
		echo "<br>\n";
		}
}
