...
function show_umpires_rating($db)
{
    ...
    echo "<tr>\n";
    echo "  <td align=\"left\" valign=\"top\">\n";
    echo "  <font class=\"10px\">You are here:</font> <a href=\"/index.php\">Home</a> &raquo; <font class=\"10px\">Umpire Ratings</font></p>\n";
    echo "  </td>\n";
    ...
    echo "<b class=\"16px\">Umpire Grades</b><br><br>\n";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
        ...
        echo "  <tr>\n";
        echo "    <td bgcolor=\"$bluebdr\" class=\"whitemain\" height=\"23\">&nbsp;UMPIRE GRADES (Under construction) </td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
    ...
    //if (!$db->Exists("SELECT te.TeamID, te.TeamAbbrev, te.TeamName, pl.* FROM players pl INNER JOIN teams te ON pl.PlayerTeam = te.TeamID WHERE pl.isumpire=1 AND te.TeamActive=1 AND pl.PlayerTeam=$teams_id[$i] ORDER BY pl.PlayerLName")) {
    ...
    //$db->QueryRow("SELECT te.TeamID, te.TeamAbbrev, te.TeamName, pl.* FROM players pl INNER JOIN teams te ON pl.PlayerTeam = te.TeamID WHERE pl.isumpire=1 AND te.TeamActive=1 AND pl.PlayerTeam=$teams_id[$i] ORDER BY pl.PlayerLName");
    //$db->BagAndTag();
    ...
    for ($r=0; $r<$db->rows; $r++) {
        ...
        $respect = htmlentities(stripslashes($db->data[respect_rating]));
    ...
    echo "    <td width=\"100%\"><a href=\"/players.php?players=$id&ccl_mode=1\">$pfn $pln</a> $decision $pressure $management $respect</td>\n";
    echo "  </tr>\n";
    }
