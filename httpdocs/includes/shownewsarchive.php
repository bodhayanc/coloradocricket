...
function show_top20_news_listing($db)
{
    ...
    echo "<b class=\"16px\">News Article Archives</b><br><br>\n";
    ...
    echo "  <img src=\"http://coloradocricket.org/images/newsoptionyear.gif\"><br>\n";
    echo "  <select name=\"theyear\">\n";

    if ($db->Exists("SELECT year(`added`) AS theyear FROM news GROUP BY theyear ORDER BY 1 Desc")) {
    ...
    echo "  <img src=\"http://coloradocricket.org/images/newsoptionmonth.gif\"><br>\n";
    ...
    echo "  <form action=\"$PHP_SELF\">\n";
    echo "  <td align=\"left\" valign=\"center\">\n";   
    echo "  <img src=\"http://coloradocricket.org/images/newsoptiontype.gif\"><br>\n";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
        ...
        echo "  <tr>\n";
        echo "    <td bgcolor=\"$greenbdr\" class=\"whitemain\" height=\"23\" align=\"left\">&nbsp;MOST POPULAR NEWS</td>\n";
    ...
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 AND views <> '0' ORDER BY views DESC LIMIT 10");
    $db->BagAndTag();
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
        ...
        echo "  <tr>\n";
        echo "    <td bgcolor=\"$yellowbdr\" class=\"whitemain\" height=\"23\">&nbsp;RECENT NEWS ARTICLES</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
    echo "  <td class=\"trrow1\" valign=\"top\" bordercolor=\"#FFFFFF\" class=\"main\" colspan=\"2\">\n";
    ...
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 ORDER BY added DESC LIMIT 35");
    $db->BagAndTag();
...
function show_popular_news_listing($db)
{
    ...
    if ($db->Exists("SELECT * FROM news")) {
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 AND views <> '0' ORDER BY views DESC LIMIT 50");
    $db->BagAndTag();
...
function show_monthly_news_listing($db,$theyear,$themonth)
{
    ...
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 AND year(added) = $theyear AND month(added) = $themonth ORDER BY id DESC");
    $db->BagAndTag();
...
function show_full_news_listing($db,$s,$id,$pr)
{
    ...
    if ($db->Exists("SELECT * FROM news")) {
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 ORDER BY id DESC");
    $db->BagAndTag();
    ...
    $db->QueryRow("SELECT * FROM news WHERE IsFeature != 1 AND views <> '0' ORDER BY views DESC LIMIT 5");
    $db->BagAndTag();
    ...
    //////////////////////////////////////////////////////////////////////////////////////////      
        ...
        echo "  <tr>\n";
        echo "    <td bgcolor=\"#000033\" class=\"whitemain\" height=\"23\">&nbsp;MORE RECENT NEWS</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
    echo "  <td class=\"trrow1\" valign=\"top\" bordercolor=\"#FFFFFF\" class=\"main\" colspan=\"2\">\n";
...
function show_full_news($db,$pr)
{
  ...
  echo "  <font class=\"10px\">You are here:</font> <a href=\"/index.php\">Home</a> &raquo; <a href=\"/news.php\">News</a> &raquo; <font class=\"10px\">News article</font></p>\n";
    echo "  </td>\n";
    //echo "  <td align=\"right\" valign=\"top\">\n";
    //require ("navtop.php");
    //echo "  </td>\n";
    ...
    echo "<img src=\"http://coloradocricket.org/images/icons/icon_email.gif\">&nbsp;<a href=\"$PHP_SELF?news=$pr&ccl_mode=3\">Email article</a>&nbsp;&nbsp;<img src=\"http://coloradocricket.org/images/icons/icon_print.gif\">&nbsp;<a href=\"http://www.coloradocricket.org/printnews.php?news=$pr&ccl_mode=1\">Print article</a>&nbsp;&nbsp;";
    if($di != 0) echo "<img src=\"http://coloradocricket.org/images/icons/icon_members.gif\">&nbsp;<a href=\"http://www.coloradocricket.org/board/viewtopic.php?t=$di\" target=\"_new\">Discuss article</a>";
    echo "  </td>\n";
    echo " </tr>\n";
    echo "</table>\n";
    ...
    echo "<hr color=\"#FCDC00\" width=\"100%\" size=\"1\" align=\"center\">\n\n";
    echo "<div align=\"right\"><img src=\"http://coloradocricket.org/images/icons/icon_email.gif\">&nbsp;<a href=\"$PHP_SELF?news=$pr&ccl_mode=3\">Email article</a>&nbsp;&nbsp;<img src=\"http://coloradocricket.org/images/icons/icon_print.gif\">&nbsp;<a href=\"http://www.coloradocricket.org/printnews.php?news=$pr&ccl_mode=1\">Print article</a>&nbsp;&nbsp;";
    if($di != 0) echo "<img src=\"http://coloradocricket.org/images/icons/icon_members.gif\">&nbsp;<a href=\"http://www.coloradocricket.org/board/viewtopic.php?t=$di\" target=\"_new\">Discuss article</a>";
    echo "</div>\n";
