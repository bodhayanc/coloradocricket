    ...
    // output story
		...
		for ($s=0; $s<$db->rows; $s++) {
			...
			if( ($s % 5) == 0 && $s == 0) {
        		...
        		echo "    <td width=85 height=80 align=center valign=top><center><a  href=\"/players.php?players=$pi&ccl_mode=1\"><img alt='$ln, $fn' align=center width=50 height=67 border=1 src=\"/uploadphotos/players/$pc\"><br>$ln,<br>$fn</a></center></td>\n";
