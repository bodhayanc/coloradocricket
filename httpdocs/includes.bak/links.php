<?php
  require 'themes.php';
    ...
    echo "<table width=\"150\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" bgcolor=\"$LEFT_AND_TOP_BK_MAIN_COLOR\">\n";
    echo "<tr>\n";
    echo "<td><img src=\"/images/nav-top.gif\" width=\"150\" height=\"20\"></td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    echo "<td>\n";

    echo " <table width=\"140\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\" align=\"right\">\n";
...
//	  "cal" => array("calendar","Calendar"),
	  ...
	  "chaukapremierscorecard" => array("cclpremierchaukaiframe.php","Chauka Premier Score"),
	  "chauka t20 scorecard" => array("CCL_T20_chaukaiframe.php","Chauka T20 scorecard"),
...
//  20140314            "chat" => array("chat.php","League Chat Room"),
	  ...
	  require 'themes.php';
        ...
        echo "</tr>\n";
        echo "<tr>\n";
        echo "   <td><img src=\"/images/nav-base.gif\" width=\"150\" height=\"20\"></td>\n";
