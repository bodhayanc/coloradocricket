...
function show_cclofficers_listing($db,$id,$offid)
{
   ...
   /* echo "<tr class=\"colhead\">\n";
    ...
    for ($i=0; $i<$db->rows; $i++) {
		...
		echo "    <td width=85 height=80 align=center valign=top><center><a  href=\"$PHP_SELF?offid=$id&ccl_mode=1\"><img alt='$lna, $fna' align=center width=50 height=67 border=1 src=\"/uploadphotos/players/$pc\"><br>$lna,$fna<br><b>$ti</b></a></center></td>\n";
