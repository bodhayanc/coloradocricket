...
function add_cougars_scorecard_step1($db)
{
	...
	if ($db->Exists("SELECT * FROM seasons WHERE SeasonName NOT LIKE '%KO%'")) {
	...
	echo " <tr>\n";
	echo "  <td width=\"50%\" align=\"right\">";
	echo "  <input type=\"text\" name=\"ground_id\" size=\"20\" maxlength=\"40\">\n";
	echo "  </td>\n";
...
function insert_cougars_scorecard_step1($db,$season,$week,$awayteam,$hometeam,$umpires,$toss_won_id,$result_won_id,$batting_first_id,$batting_second_id,$ground_id,$game_date,$result,$forfeit,$cancelled)
{
...
// This is a forfeited game
	...
	if ($season == "" || $awayteam == "" || $hometeam == "" || $game_date == "") {
	...
	$db->Insert("INSERT INTO cougars_scorecard_game_details (season,week,awayteam,hometeam,game_date,forfeit,isactive) VALUES ('$se','$we','$at','$ht','$gd','$fo',0)");
...
// This is a cancelled game	
	...
	$db->Insert("INSERT INTO cougars_scorecard_game_details (season,week,awayteam,hometeam,game_date,cancelled,isactive) VALUES ('$se','$we','$at','$ht','$gd','$ca',0)");
...
// This is a normal game
	...
	$db->Insert("INSERT INTO cougars_scorecard_game_details (season,week,awayteam,hometeam,umpires,toss_won_id,result_won_id,batting_first_id,batting_second_id,ground_id,game_date,result,forfeit,cancelled,isactive) VALUES ('$se','$we','$at','$ht','$um','$tw','$rw','$bf','$bs','$gi','$gd','$re','$fo','$ca',0)");
...
function add_cougars_scorecard_step2($db,$season,$game_date,$awayteam,$hometeam)
{
	global $PHP_SELF, $content,$action,$SID, $bluebdr, $greenbdr, $yellowbdr;
	...
	FROM
	  cougars_scorecard_game_details s
	INNER JOIN
	  cougarsteams a ON s.awayteam = a.TeamID
	INNER JOIN
	  cougarsteams h ON s.hometeam = h.TeamID
	LEFT JOIN
	  cougarsteams u ON s.umpires = u.TeamID
	LEFT JOIN
	  cougarsteams t ON s.toss_won_id = t.TeamID
	INNER JOIN
	  cougarsteams b ON s.batting_first_id = b.TeamID
	INNER JOIN
	  cougarsteams n ON s.batting_second_id = n.TeamID	  
	WHERE 
	...
	echo "<input type=\"hidden\" name=\"bat_team_id\" value=\"$bat1stid\">\n";
	echo "<input type=\"hidden\" name=\"bowl_team_id\" value=\"$bat2ndid\">\n";
...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	echo "	<option value=\"\">---------------</option>\n";
	if($bat1stid != "1") {
		$db->Query("SELECT * FROM cougarsplayers WHERE CougarTeam = $bat1stid ORDER BY NotCougarPlayer");
	} else {
		$db->Query("SELECT cp.*,pl.* FROM cougarsplayers cp LEFT JOIN players pl ON cp.CougarPlayer = pl.PlayerID WHERE cp.CougarTeam = $bat1stid ORDER BY pl.PlayerLName");	
	}
		for ($i=0; $i<$db->rows; $i++) {
			$db->GetRow($i);
	...
	echo "	<option value=\"\">---------------</option>\n";
	if($bat2ndid != "1") {
		$db->Query("SELECT * FROM cougarsplayers WHERE CougarTeam = $bat2ndid ORDER BY NotCougarPlayer");
	} else {
		$db->Query("SELECT cp.*,pl.* FROM cougarsplayers cp LEFT JOIN players pl ON cp.CougarPlayer = pl.PlayerID WHERE cp.CougarTeam = $bat2ndid ORDER BY pl.PlayerLName");	
	}
...
function insert_cougars_scorecard_step2($db,$game_id,$season,$innings_id,$bat_team_id,$bowl_team_id,$oneplayer_id,$onehow_out,$oneassist,$onebowler,$oneruns,$oneballs,$onefours,$onesixes,$twoplayer_id,$twohow_out,$twoassist,$twobowler,$tworuns,$twoballs,$twofours,$twosixes,$threeplayer_id,$threehow_out,$threeassist,$threebowler,$threeruns,$threeballs,$threefours,$threesixes,$fourplayer_id,$fourhow_out,$fourassist,$fourbowler,$fourruns,$fourballs,$fourfours,$foursixes,$fiveplayer_id,$fivehow_out,$fiveassist,$fivebowler,$fiveruns,$fiveballs,$fivefours,$fivesixes,$sixplayer_id,$sixhow_out,$sixassist,$sixbowler,$sixruns,$sixballs,$sixfours,$sixsixes,$sevenplayer_id,$sevenhow_out,$sevenassist,$sevenbowler,$sevenruns,$sevenballs,$sevenfours,$sevensixes,$eightplayer_id,$eighthow_out,$eightassist,$eightbowler,$eightruns,$eightballs,$eightfours,$eightsixes,$nineplayer_id,$ninehow_out,$nineassist,$ninebowler,$nineruns,$nineballs,$ninefours,$ninesixes,$tenplayer_id,$tenhow_out,$tenassist,$tenbowler,$tenruns,$tenballs,$tenfours,$tensixes,$elevenplayer_id,$elevenhow_out,$elevenassist,$elevenbowler,$elevenruns,$elevenballs,$elevenfours,$elevensixes,$totwickets,$totovers,$tottotal,$extlegbyes,$extbyes,$extwides,$extnoballs,$exttotal,$fowone,$fowtwo,$fowthree,$fowfour,$fowfive,$fowsix,$fowseven,$foweight,$fownine,$fowten,$onebowler_id,$oneovers,$onemaidens,$onebowruns,$onewickets,$onenoballs,$onewides,$twobowler_id,$twoovers,$twomaidens,$twobowruns,$twowickets,$twonoballs,$twowides,$threebowler_id,$threeovers,$threemaidens,$threebowruns,$threewickets,$threenoballs,$threewides,$fourbowler_id,$fourovers,$fourmaidens,$fourbowruns,$fourwickets,$fournoballs,$fourwides,$fivebowler_id,$fiveovers,$fivemaidens,$fivebowruns,$fivewickets,$fivenoballs,$fivewides,$sixbowler_id,$sixovers,$sixmaidens,$sixbowruns,$sixwickets,$sixnoballs,$sixwides,$sevenbowler_id,$sevenovers,$sevenmaidens,$sevenbowruns,$sevenwickets,$sevennoballs,$sevenwides,$eightbowler_id,$eightovers,$eightmaidens,$eightbowruns,$eightwickets,$eightnoballs,$eightwides,$ninebowler_id,$nineovers,$ninemaidens,$ninebowruns,$ninewickets,$ninenoballs,$ninewides,$tenbowler_id,$tenovers,$tenmaidens,$tenbowruns,$tenwickets,$tennoballs,$tenwides,$elevenbowler_id,$elevenovers,$elevenmaidens,$elevenbowruns,$elevenwickets,$elevennoballs,$elevenwides,$onebatpos,$twobatpos,$threebatpos,$fourbatpos,$fivebatpos,$sixbatpos,$sevenbatpos,$eightbatpos,$ninebatpos,$tenbatpos,$elevenbatpos,$onebowpos,$twobowpos,$threebowpos,$fourbowpos,$fivebowpos,$sixbowpos,$sevenbowpos,$eightbowpos,$ninebowpos,$tenbowpos,$elevenbowpos)
{
	...
	$batte = addslashes(trim($bat_team_id));
	$bowte = addslashes(trim($bowl_team_id));
	...
	$db->Insert("INSERT INTO cougars_scorecard_extras_details (game_id,innings_id,legbyes,byes,wides,noballs,total) VALUES ('$game_id','$innings_id','$extl','$extb','$extw','$extn','$extt')");
	$db->Insert("INSERT INTO cougars_scorecard_total_details (game_id,innings_id,wickets,total,overs) VALUES ('$game_id','$innings_id','$totw','$tott','$toto')");
	$db->Insert("INSERT INTO cougars_scorecard_fow_details (game_id,innings_id,fow1,fow2,fow3,fow4,fow5,fow6,fow7,fow8,fow9,fow10) VALUES ('$game_id','$innings_id','$f1','$f2','$f3','$f4','$f5','$f6','$f7','$f8','$f9','$f10')");	


	// check to see if there is an entry of batter

	if ($onepl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$onepl','$onebap','$oneho','$oneru','$oneas','$onebo','$oneba','$onefo','$onesi','$oneno')");
	if ($twopl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$twopl','$twobap','$twoho','$tworu','$twoas','$twobo','$twoba','$twofo','$twosi','$twono')");
	if ($threepl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$threepl','$threebap','$threeho','$threeru','$threeas','$threebo','$threeba','$threefo','$threesi','$threeno')");
	if ($fourpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$fourpl','$fourbap','$fourho','$fourru','$fouras','$fourbo','$fourba','$fourfo','$foursi','$fourno')");
	if ($fivepl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$fivepl','$fivebap','$fiveho','$fiveru','$fiveas','$fivebo','$fiveba','$fivefo','$fivesi','$fiveno')");
	if ($sixpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$sixpl','$sixbap','$sixho','$sixru','$sixas','$sixbo','$sixba','$sixfo','$sixsi','$sixno')");
	if ($sevenpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$sevenpl','$sevenbap','$sevenho','$sevenru','$sevenas','$sevenbo','$sevenba','$sevenfo','$sevensi','$sevenno')");
	if ($eightpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$eightpl','$eightbap','$eightho','$eightru','$eightas','$eightbo','$eightba','$eightfo','$eightsi','$eightno')");
	if ($ninepl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$ninepl','$ninebap','$nineho','$nineru','$nineas','$ninebo','$nineba','$ninefo','$ninesi','$nineno')");
	if ($tenpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$tenpl','$tenbap','$tenho','$tenru','$tenas','$tenbo','$tenba','$tenfo','$tensi','$tenno')");
	if ($elevenpl != "") 	$db->Insert("INSERT INTO cougars_scorecard_batting_details (game_id,season,innings_id,player_id,batting_position,how_out,runs,assist,bowler,balls,fours,sixes,notout) VALUES ('$game_id','$season','$innings_id','$elevenpl','$elevenbap','$elevenho','$elevenru','$elevenas','$elevenbo','$elevenba','$elevenfo','$elevensi','$elevenno')");

	// check to see if there is an entry of bowler

	if ($onebow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$onebow','$onebop','$oneove','$onemai','$onebru','$onewic','$onenob','$onewid')");
	if ($twobow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$twobow','$twobop','$twoove','$twomai','$twobru','$twowic','$twonob','$twowid')");
	if ($threebow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$threebow','$threebop','$threeove','$threemai','$threebru','$threewic','$threenob','$threewid')");
	if ($fourbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$fourbow','$fourbop','$fourove','$fourmai','$fourbru','$fourwic','$fournob','$fourwid')");
	if ($fivebow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$fivebow','$fivebop','$fiveove','$fivemai','$fivebru','$fivewic','$fivenob','$fivewid')");
	if ($sixbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$sixbow','$sixbop','$sixove','$sixmai','$sixbru','$sixwic','$sixnob','$sixwid')");
	if ($sevenbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$sevenbow','$sevenbop','$sevenove','$sevenmai','$sevenbru','$sevenwic','$sevennob','$sevenwid')");
	if ($eightbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$eightbow','$eightbop','$eightove','$eightmai','$eightbru','$eightwic','$eightnob','$eightwid')");
	if ($ninebow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$ninebow','$ninebop','$nineove','$ninemai','$ninebru','$ninewic','$ninenob','$ninewid')");
	if ($tenbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$tenbow','$tenbop','$tenove','$tenmai','$tenbru','$tenwic','$tennob','$tenwid')");
	if ($elevenbow != "") 	$db->Insert("INSERT INTO cougars_scorecard_bowling_details (game_id,season,innings_id,bowl_team_id,player_id,bowling_position,overs,maidens,runs,wickets,noballs,wides) VALUES ('$game_id','$season','$innings_id','$bowte','$elevenbow','$elevenbop','$elevenove','$elevenmai','$elevenbru','$elevenwic','$elevennob','$elevenwid')");
...
function add_cougars_scorecard_step3($db,$game_id,$season)
{
	global $PHP_SELF, $content,$action,$SID, $bluebdr, $greenbdr, $yellowbdr;
	...
	echo "<input type=\"hidden\" name=\"game_id\" value=\"$gid\">\n";
	echo "<input type=\"hidden\" name=\"bat_team_id\" value=\"$bat2ndid\">\n";
	echo "<input type=\"hidden\" name=\"bowl_team_id\" value=\"$bat1stid\">\n";
	echo "<input type=\"hidden\" name=\"season\" value=\"$gsc\">\n";
	echo "<input type=\"hidden\" name=\"onebatpos\" value=\"1\">\n";
	echo "<input type=\"hidden\" name=\"twobatpos\" value=\"2\">\n";
	echo "<input type=\"hidden\" name=\"threebatpos\" value=\"3\">\n";
...
function insert_cougars_scorecard_step3($db,$game_id,$season,$innings_id,$bat_team_id,$bowl_team_id,$oneplayer_id,$onehow_out,$oneassist,$onebowler,$oneruns,$oneballs,$onefours,$onesixes,$twoplayer_id,$twohow_out,$twoassist,$twobowler,$tworuns,$twoballs,$twofours,$twosixes,$threeplayer_id,$threehow_out,$threeassist,$threebowler,$threeruns,$threeballs,$threefours,$threesixes,$fourplayer_id,$fourhow_out,$fourassist,$fourbowler,$fourruns,$fourballs,$fourfours,$foursixes,$fiveplayer_id,$fivehow_out,$fiveassist,$fivebowler,$fiveruns,$fiveballs,$fivefours,$fivesixes,$sixplayer_id,$sixhow_out,$sixassist,$sixbowler,$sixruns,$sixballs,$sixfours,$sixsixes,$sevenplayer_id,$sevenhow_out,$sevenassist,$sevenbowler,$sevenruns,$sevenballs,$sevenfours,$sevensixes,$eightplayer_id,$eighthow_out,$eightassist,$eightbowler,$eightruns,$eightballs,$eightfours,$eightsixes,$nineplayer_id,$ninehow_out,$nineassist,$ninebowler,$nineruns,$nineballs,$ninefours,$ninesixes,$tenplayer_id,$tenhow_out,$tenassist,$tenbowler,$tenruns,$tenballs,$tenfours,$tensixes,$elevenplayer_id,$elevenhow_out,$elevenassist,$elevenbowler,$elevenruns,$elevenballs,$elevenfours,$elevensixes,$totwickets,$totovers,$tottotal,$extlegbyes,$extbyes,$extwides,$extnoballs,$exttotal,$fowone,$fowtwo,$fowthree,$fowfour,$fowfive,$fowsix,$fowseven,$foweight,$fownine,$fowten,$onebowler_id,$oneovers,$onemaidens,$onebowruns,$onewickets,$onenoballs,$onewides,$twobowler_id,$twoovers,$twomaidens,$twobowruns,$twowickets,$twonoballs,$twowides,$threebowler_id,$threeovers,$threemaidens,$threebowruns,$threewickets,$threenoballs,$threewides,$fourbowler_id,$fourovers,$fourmaidens,$fourbowruns,$fourwickets,$fournoballs,$fourwides,$fivebowler_id,$fiveovers,$fivemaidens,$fivebowruns,$fivewickets,$fivenoballs,$fivewides,$sixbowler_id,$sixovers,$sixmaidens,$sixbowruns,$sixwickets,$sixnoballs,$sixwides,$sevenbowler_id,$sevenovers,$sevenmaidens,$sevenbowruns,$sevenwickets,$sevennoballs,$sevenwides,$eightbowler_id,$eightovers,$eightmaidens,$eightbowruns,$eightwickets,$eightnoballs,$eightwides,$ninebowler_id,$nineovers,$ninemaidens,$ninebowruns,$ninewickets,$ninenoballs,$ninewides,$tenbowler_id,$tenovers,$tenmaidens,$tenbowruns,$tenwickets,$tennoballs,$tenwides,$elevenbowler_id,$elevenovers,$elevenmaidens,$elevenbowruns,$elevenwickets,$elevennoballs,$elevenwides,$onebatpos,$twobatpos,$threebatpos,$fourbatpos,$fivebatpos,$sixbatpos,$sevenbatpos,$eightbatpos,$ninebatpos,$tenbatpos,$elevenbatpos,$onebowpos,$twobowpos,$threebowpos,$fourbowpos,$fivebowpos,$sixbowpos,$sevenbowpos,$eightbowpos,$ninebowpos,$tenbowpos,$elevenbowpos)
{
	global $PHP_SELF,$content,$action,$SID, $bluebdr, $greenbdr, $yellowbdr;
...
switch($ccl_mode) {
case 0:
	add_cougars_scorecard_step1($db);
	break;
case 1:
	insert_cougars_scorecard_step1($db,$season,$week,$awayteam,$hometeam,$umpires,$toss_won_id,$result_won_id,$batting_first_id,$batting_second_id,$ground_id,$game_date,$result,$forfeit,$cancelled);
	break;
case 2:
	add_cougars_scorecard_step2($db,$season,$game_date,$awayteam,$hometeam);
	break;
case 3:
	insert_cougars_scorecard_step2($db,$game_id,$season,$innings_id,$bat_team_id,$oneplayer_id,$onehow_out,$oneassist,$onebowler,$oneruns,$oneballs,$onefours,$onesixes,$twoplayer_id,$twohow_out,$twoassist,$twobowler,$tworuns,$twoballs,$twofours,$twosixes,$threeplayer_id,$threehow_out,$threeassist,$threebowler,$threeruns,$threeballs,$threefours,$threesixes,$fourplayer_id,$fourhow_out,$fourassist,$fourbowler,$fourruns,$fourballs,$fourfours,$foursixes,$fiveplayer_id,$fivehow_out,$fiveassist,$fivebowler,$fiveruns,$fiveballs,$fivefours,$fivesixes,$sixplayer_id,$sixhow_out,$sixassist,$sixbowler,$sixruns,$sixballs,$sixfours,$sixsixes,$sevenplayer_id,$sevenhow_out,$sevenassist,$sevenbowler,$sevenruns,$sevenballs,$sevenfours,$sevensixes,$eightplayer_id,$eighthow_out,$eightassist,$eightbowler,$eightruns,$eightballs,$eightfours,$eightsixes,$nineplayer_id,$ninehow_out,$nineassist,$ninebowler,$nineruns,$nineballs,$ninefours,$ninesixes,$tenplayer_id,$tenhow_out,$tenassist,$tenbowler,$tenruns,$tenballs,$tenfours,$tensixes,$elevenplayer_id,$elevenhow_out,$elevenassist,$elevenbowler,$elevenruns,$elevenballs,$elevenfours,$elevensixes,$totwickets,$totovers,$tottotal,$extlegbyes,$extbyes,$extwides,$extnoballs,$exttotal,$fowone,$fowtwo,$fowthree,$fowfour,$fowfive,$fowsix,$fowseven,$foweight,$fownine,$fowten,$onebowler_id,$oneovers,$onemaidens,$onebowruns,$onewickets,$onenoballs,$onewides,$twobowler_id,$twoovers,$twomaidens,$twobowruns,$twowickets,$twonoballs,$twowides,$threebowler_id,$threeovers,$threemaidens,$threebowruns,$threewickets,$threenoballs,$threewides,$fourbowler_id,$fourovers,$fourmaidens,$fourbowruns,$fourwickets,$fournoballs,$fourwides,$fivebowler_id,$fiveovers,$fivemaidens,$fivebowruns,$fivewickets,$fivenoballs,$fivewides,$sixbowler_id,$sixovers,$sixmaidens,$sixbowruns,$sixwickets,$sixnoballs,$sixwides,$sevenbowler_id,$sevenovers,$sevenmaidens,$sevenbowruns,$sevenwickets,$sevennoballs,$sevenwides,$eightbowler_id,$eightovers,$eightmaidens,$eightbowruns,$eightwickets,$eightnoballs,$eightwides,$ninebowler_id,$nineovers,$ninemaidens,$ninebowruns,$ninewickets,$ninenoballs,$ninewides,$tenbowler_id,$tenovers,$tenmaidens,$tenbowruns,$tenwickets,$tennoballs,$tenwides,$elevenbowler_id,$elevenovers,$elevenmaidens,$elevenbowruns,$elevenwickets,$elevennoballs,$elevenwides,$onebatpos,$twobatpos,$threebatpos,$fourbatpos,$fivebatpos,$sixbatpos,$sevenbatpos,$eightbatpos,$ninebatpos,$tenbatpos,$elevenbatpos,$onebowpos,$twobowpos,$threebowpos,$fourbowpos,$fivebowpos,$sixbowpos,$sevenbowpos,$eightbowpos,$ninebowpos,$tenbowpos,$elevenbowpos);
	break;	
case 4:
	add_cougars_scorecard_step3($db,$game_id,$season);
	break;	
case 5:
	insert_cougars_scorecard_step3($db,$game_id,$season,$innings_id,$bowl_team_id,$oneplayer_id,$onehow_out,$oneassist,$onebowler,$oneruns,$oneballs,$onefours,$onesixes,$twoplayer_id,$twohow_out,$twoassist,$twobowler,$tworuns,$twoballs,$twofours,$twosixes,$threeplayer_id,$threehow_out,$threeassist,$threebowler,$threeruns,$threeballs,$threefours,$threesixes,$fourplayer_id,$fourhow_out,$fourassist,$fourbowler,$fourruns,$fourballs,$fourfours,$foursixes,$fiveplayer_id,$fivehow_out,$fiveassist,$fivebowler,$fiveruns,$fiveballs,$fivefours,$fivesixes,$sixplayer_id,$sixhow_out,$sixassist,$sixbowler,$sixruns,$sixballs,$sixfours,$sixsixes,$sevenplayer_id,$sevenhow_out,$sevenassist,$sevenbowler,$sevenruns,$sevenballs,$sevenfours,$sevensixes,$eightplayer_id,$eighthow_out,$eightassist,$eightbowler,$eightruns,$eightballs,$eightfours,$eightsixes,$nineplayer_id,$ninehow_out,$nineassist,$ninebowler,$nineruns,$nineballs,$ninefours,$ninesixes,$tenplayer_id,$tenhow_out,$tenassist,$tenbowler,$tenruns,$tenballs,$tenfours,$tensixes,$elevenplayer_id,$elevenhow_out,$elevenassist,$elevenbowler,$elevenruns,$elevenballs,$elevenfours,$elevensixes,$totwickets,$totovers,$tottotal,$extlegbyes,$extbyes,$extwides,$extnoballs,$exttotal,$fowone,$fowtwo,$fowthree,$fowfour,$fowfive,$fowsix,$fowseven,$foweight,$fownine,$fowten,$onebowler_id,$oneovers,$onemaidens,$onebowruns,$onewickets,$onenoballs,$onewides,$twobowler_id,$twoovers,$twomaidens,$twobowruns,$twowickets,$twonoballs,$twowides,$threebowler_id,$threeovers,$threemaidens,$threebowruns,$threewickets,$threenoballs,$threewides,$fourbowler_id,$fourovers,$fourmaidens,$fourbowruns,$fourwickets,$fournoballs,$fourwides,$fivebowler_id,$fiveovers,$fivemaidens,$fivebowruns,$fivewickets,$fivenoballs,$fivewides,$sixbowler_id,$sixovers,$sixmaidens,$sixbowruns,$sixwickets,$sixnoballs,$sixwides,$sevenbowler_id,$sevenovers,$sevenmaidens,$sevenbowruns,$sevenwickets,$sevennoballs,$sevenwides,$eightbowler_id,$eightovers,$eightmaidens,$eightbowruns,$eightwickets,$eightnoballs,$eightwides,$ninebowler_id,$nineovers,$ninemaidens,$ninebowruns,$ninewickets,$ninenoballs,$ninewides,$tenbowler_id,$tenovers,$tenmaidens,$tenbowruns,$tenwickets,$tennoballs,$tenwides,$elevenbowler_id,$elevenovers,$elevenmaidens,$elevenbowruns,$elevenwickets,$elevennoballs,$elevenwides,$onebatpos,$twobatpos,$threebatpos,$fourbatpos,$fivebatpos,$sixbatpos,$sevenbatpos,$eightbatpos,$ninebatpos,$tenbatpos,$elevenbatpos,$onebowpos,$twobowpos,$threebowpos,$fourbowpos,$fivebowpos,$sixbowpos,$sevenbowpos,$eightbowpos,$ninebowpos,$tenbowpos,$elevenbowpos);
	break;	
case 6:
	finished($db);
	break;
