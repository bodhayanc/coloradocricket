...
if ($_FILES['userpic1']['name'] != "") {
  $uploaddir = "../uploadphotos/players/action/";
  $basename = basename($_FILES['userpic1']['name']);
  $uploadfile = $uploaddir . $basename;

  if (move_uploaded_file($_FILES['userpic1']['tmp_name'], $uploadfile)) {
    $setpic1 = ",picture1='$basename'";
  } else {
    echo "<p>That photo could not be uploaded at this time - no photo was added to the database.</p>\n";
  }
}
