...
function do_add_category($db,$uid,$featureexpire,$title,$author,$article,$IsFeature,$DiscussID,$MasterID,$SubTitle,$picdesc,$picture)
{
	...
	if($ex == "7")  { $db->Insert("INSERT INTO news (added,featureexpire,user,title,author,article,IsFeature,DiscussID,MasterID,SubTitle,picdesc,newstype) VALUES ('$d',DATE_ADD(CURDATE(),INTERVAL 7 DAY),'$uid','$t','$au','$a','$if','$di','$mi','$st','$pd'$picture,1)");
