...
function show_schedule_listing($db,$schedule,$id,$pr,$team,$week)
{
    ...
    if ($db->Exists("SELECT * FROM seasons")) {
        ...
        echo "  <tr>\n";
        echo "    <td bgcolor=\"$greenbdr\" class=\"whitemain\" height=\"23\">Select a season scorecard</td>\n";
        echo "  </tr>\n";
        echo "  <tr>\n";
        ...
        echo "</table>\n";
            ...
            echo "  <tr>\n";
            echo "    <td align=\"left\" valign=\"top\">\n";
            echo "    <p>There are no scorecards in the database.</p>\n";
...
function show_schedule($db,$schedule,$id,$pr,$team,$week)
{
        ...
        echo "    <td align=\"left\" valign=\"top\">\n";
        echo "    <a href=\"/index.php\">Home</a> &gt; Scorecards</p>\n";
        echo "    <p>There are currently no scorecards in the database.</p>\n";
        echo "    <p><a href=\"/index.php\">&laquo; back to homepage</a></p>\n";
        echo "    </td>\n";
        echo "  </tr>\n";
        echo "</table>\n";
            ...
            echo "<tr>\n";
            echo "  <td align=\"left\" valign=\"top\">\n";
            echo "  <a href=\"/index.php\">Home</a> &raquo; <a href=\"/schedule.php\">Scorecards</a> &raquo; {$seasons[$schedule]}</p>\n";
            echo "  </td>\n";
            echo "  <td align=\"right\" valign=\"top\">\n";
            require ("../cougars/includes/navtop.php");
            echo "  </td>\n";
            ...
            echo "<p class=\"16px\">{$seasons[$schedule]} Cougars Scorecards</p>\n";

                echo "<table width=\"100%\" border=\"1\" cellspacing=\"0\" cellpadding=\"0\" bordercolor=\"$bluebdr\" align=\"center\">\n";
                echo "  <tr>\n";
                echo "    <td bgcolor=\"$bluebdr\" class=\"whitemain\" height=\"23\">&nbsp;Cougars Scorecards</td>\n";
                echo "  </tr>\n";
                echo "  <tr>\n";
