...
function show_randomsponsor($db)
{
	...
	if (!$db->Exists("SELECT * FROM sponsors WHERE isActive=1")) {
		...
		echo "
			...
			imageholder[i].src='http://www.coloradocricket.org/uploadphotos/sponsors/' + slideimages[i]
			}
		...
		//echo "<center><a href=\"javascript:gotoshow()\"><img src=\"http://www.coloradocricket.org/uploadphotos/sponsors/$first_img\" name=\"slide\" border=0 style=\"filter:blendTrans(duration=3)\" ></a></center>";
                echo "<center><a href=$first_href target='_blank'><img src=\"http://www.coloradocricket.org/uploadphotos/sponsors/$first_img\" name=\"slide\" border=0 style=\"filter:blendTrans(duration=3)\" ></a></center>";
		echo "<br>\n";
