...
function do_add_category($db,$id,$PlayerLName,$PlayerFName,$PlayerTeam,$PlayerEmail,$shortprofile,$IsUmpire,$IsPresident,$IsVicePresident,$IsSecretary,$IsTreasurer,$IsCaptain,$IsViceCaptain,$Born,$BattingStyle,$BowlingStyle,$picture,$picture1)
{
    ...
    $db->Insert("INSERT INTO tennisplayers (PlayerLName,PlayerFName,PlayerTeam,PlayerEmail,shortprofile,IsUmpire,IsPresident,IsVicePresident,IsSecretary,IsTreasurer,IsCaptain,IsViceCaptain,Born,BattingStyle,BowlingStyle,picture,picture1) VALUES ('$pln','$pfn','$pte','$pem','$spr','$ump','$pre','$vpr','$sec','$tre','$cap','$vca','$bor','$bat','$bow','$picture','$picture1')");
    if ($db->a_rows != -1) {
...
do_add_category($db,$id,$PlayerLName,$PlayerFName,$PlayerTeam,$PlayerEmail,$shortprofile,$IsUmpire,$IsPresident,$IsVicePresident,$IsSecretary,$IsTreasurer,$IsCaptain,$IsViceCaptain,$Born,$BattingStyle,$BowlingStyle,$picture,$picture1);
